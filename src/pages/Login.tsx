      ...
      >
        <div className="relative backdrop-blur-xl bg-white/5 border border-white/10 rounded-3xl p-8 shadow-2xl overflow-hidden">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Sign in to your Ayazma ONE account</p>
          </div>
          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-[#0F172A]/50 backdrop-blur-xl text-gray-500 rounded-full border border-white/5">or continue with</span>
              </div>
            </div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <button
                ...
                className="flex items-center justify-center w-full px-4 py-3 bg-white text-gray-900 hover:bg-gray-100 rounded-xl transition-colors font-medium text-sm"
                type="button"
              >
              ...
              <button
                ...
                className="flex items-center justify-center w-full px-4 py-3 bg-[#24292e] text-white hover:bg-[#2f363d] rounded-xl transition-colors font-medium text-sm"
                type="button"
              >
